...
const AppLayout = ({ 
  ...
  return (
    <div className="cannon-app">
      {/* Mobile menu button */}
      <button 
        className="cannon-hamburger-menu" 
      ...
      {/* Left sidebar */}
      <div className={`cannon-sidebar ${sidebarVisible ? 'visible' : ''}`}>
        <div className="cannon-sidebar-content">
          {sidebar}
        </div>
        
        <div className="cannon-sidebar-footer">
          {apiKeyRequired && (
            <div className="cannon-api-key-notice">
